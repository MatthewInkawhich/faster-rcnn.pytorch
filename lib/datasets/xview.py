...
class xview(imdb):
    def __init__(self, image_set, chip_scale, devkit_path=None):
        imdb.__init__(self, 'xview')
        self._image_set = image_set
        self._chip_scale = chip_scale
    ...
    def gt_roidb(self):
        ...
        """
        cache_file = os.path.join(self.cache_path, self.name + '_' + self._chip_scale + '_gt_roidb_' + self._image_set + '.pkl')
...
#        return self.create_roidb_from_box_list(box_list, gt_roidb)
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', cfg.EXP_DIR, 'Main')
